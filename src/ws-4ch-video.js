...
export default class WS4ChVideo extends Rect {
  ...
  _draw(ctx) {
    ...
    if(!this._ws1 && this._isPlaying) {
      ...
      this._ws1 = new MpegWs(this.model.url1, {
    ...
    if(!this._ws2 && this._isPlaying) {
      ...
      this._ws2 = new MpegWs(this.model.url2, {
        ondecodeframe: this.drawDecoded.bind(this)
      })
    }
    ...
    if(!this._ws3 && this._isPlaying) {
      ...
      this._ws3 = new MpegWs(this.model.url3, {
        ondecodeframe: this.drawDecoded.bind(this)
      })
    }
    ...
    if(!this._ws4 && this._isPlaying) {
      ...
      this._ws4 = new MpegWs(this.model.url4, {
        ondecodeframe: this.drawDecoded.bind(this)
      })
    }
  ...
  reconnect() {
    if(this._ws1 && this._ws1.client)
      this._ws1.client.close();

    this._ws1 = null

    if(this._ws2 && this._ws2.client)
      this._ws2.client.close();

    this._ws2 = null

    if(this._ws3 && this._ws3.client)
      this._ws3.client.close();

    this._ws3 = null

    if(this._ws4 && this._ws4.client)
      this._ws4.client.close();
